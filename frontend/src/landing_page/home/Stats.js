    ...
    return ( 
        ...
        <div className="container p-3">
            <div className="row p-5">
                ...
                <div className="col-6 p-5">
                    <img src="media/images/ecosystem.png" style={{width:"90%"}} alt="imgeco" />
                    <div className='text-center'>
                        <a href="" className='mx-5' style={{textDecoration:"none"}}>Explore our products <i class="fa fa-arrow-right" aria-hidden="true"></i>
</a>
                        <a href=""  style={{textDecoration:"none"}}>Try Kite Now<i class="fa fa-arrow-right" aria-hidden="true"></i>
</a>
                    </div>
                </div>
            </div>
